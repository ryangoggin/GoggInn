...
* Request
  * Method: GET
  * URL: /users/current (do NOT use dynamic value when login required)
  * Body: none
...
* Request
  * Method: POST
  * URL: /api/session (create a session for logged in user)
  * Headers:
    * Content-Type: application/json
  * Body:
